...
-- ----------------------------
-- Table structure for qz_employee_leave
-- ----------------------------
DROP TABLE IF EXISTS `qz_employee_leave`;
CREATE TABLE `qz_employee_leave` (
  `el_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `u_id` int(11) DEFAULT NULL COMMENT '请假员工',
  `el_sdate` int(11) DEFAULT NULL COMMENT '请假开始时间',
  `el_edate` int(11) DEFAULT NULL COMMENT '请假结束时间',
  `el_length` int(11) DEFAULT NULL COMMENT '请假时长',
  PRIMARY KEY (`el_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='请假记录';

-- ----------------------------
-- Records of qz_employee_leave
-- ----------------------------
